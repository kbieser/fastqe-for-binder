# Taken from - Copyright (c) Jupyter Development Team.
...
LABEL maintainer="Jason Williams, williams@cshl.edu"
LABEL jupyterlab="1.2.0"
ARG NB_USER="cyverse_user"
ARG NB_UID="1000"
ARG NB_GID="100"
...
# Create NB_USER wtih name $NB_USER user with UID=1000 and in the 'users' group
...
RUN mkdir -p /home/cyverse_user/.irods
RUN chown -R cyverse_user:users /home/cyverse_user
